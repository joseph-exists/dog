...
class PackageApi:
    ...
    def link_package(
        ...
        type: Annotated[StrictStr, Field(description="type of the package")],
        name: Annotated[StrictStr, Field(description="name of the package")],
        repo_name: Annotated[StrictStr, Field(description="name of the repository to link.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param name: name of the package (required)
        :type name: str
        :param repo_name: name of the repository to link. (required)
        :type repo_name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._link_package_serialize(
            owner=owner,
            type=type,
            name=name,
            repo_name=repo_name,
    ...
    def _link_package_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/packages/{owner}/{type}/{name}/-/link/{repo_name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def unlink_package(
        ...
        _param = self._unlink_package_serialize(
            owner=owner,
            type=type,
            name=name,
            _request_auth=_request_auth,
    ...
    def _unlink_package_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/packages/{owner}/{type}/{name}/-/unlink',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
