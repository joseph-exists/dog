...
class NotificationApi:
    ...
    def notify_get_thread(
        self,
        id: Annotated[StrictInt, Field(description="id of notification thread")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def notify_read_list(
        ...
        all: Annotated[Optional[StrictBool], Field(description="If true, mark all notifications on this repo. Default value is false")] = None,
