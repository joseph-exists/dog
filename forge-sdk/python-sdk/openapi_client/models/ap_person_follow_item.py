...
class APPersonFollowItem(BaseModel):
    """
    APPersonFollowItem
    """ # noqa: E501
    actor_id: Optional[StrictStr] = None
    note: Optional[StrictStr] = None
    original_item: Optional[StrictStr] = None
    original_url: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["actor_id", "note", "original_item", "original_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "note": obj.get("note"),
            "original_item": obj.get("original_item"),
