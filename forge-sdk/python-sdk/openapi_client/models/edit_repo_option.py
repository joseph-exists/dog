...
class EditRepoOption(BaseModel):
    ...
    default_merge_style: Optional[StrictStr] = Field(default=None, description="set to a merge style to be used by this repository: \"merge\", \"rebase\", \"rebase-merge\", \"squash\", \"fast-forward-only\", \"manually-merged\", or \"rebase-update-only\".")
    default_update_style: Optional[StrictStr] = Field(default=None, description="set to a update style to be used by this repository: \"rebase\" or \"merge\"")
    description: Optional[StrictStr] = Field(default=None, description="a short description of the repository.")
    enable_prune: Optional[StrictBool] = Field(default=None, description="enable prune - remove obsolete remote-tracking references when mirroring")
    external_tracker: Optional[ExternalTracker] = None
    external_wiki: Optional[ExternalWiki] = None
    globally_editable_wiki: Optional[StrictBool] = Field(default=None, description="set the globally editable state of the wiki")
    ...
    wiki_branch: Optional[StrictStr] = Field(default=None, description="sets the branch used for this repository's wiki.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "default_update_style": obj.get("default_update_style"),
            ...
            "globally_editable_wiki": obj.get("globally_editable_wiki"),
            ...
            "wiki_branch": obj.get("wiki_branch")
        })
        return _obj
