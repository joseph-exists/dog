...
class User(BaseModel):
    ...
    html_url: Optional[StrictStr] = Field(default=None, description="URL to the user's profile page")
    ...
    pronouns: Optional[StrictStr] = Field(default=None, description="the user's pronouns")
    ...
    __properties: ClassVar[List[str]] = ["active", "avatar_url", "created", "description", "email", "followers_count", "following_count", "full_name", "html_url", "id", "is_admin", "language", "last_login", "location", "login", "login_name", "prohibit_login", "pronouns", "restricted", "source_id", "starred_repos_count", "visibility", "website"]
