...
class CreatePushMirrorOption(BaseModel):
    ...
    use_ssh: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["branch_filter", "interval", "remote_address", "remote_password", "remote_username", "sync_on_commit", "use_ssh"]
