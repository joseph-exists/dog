...
class Release(BaseModel):
    ...
    """ # noqa: E501
    archive_download_count: Optional[TagArchiveDownloadCount] = None
    assets: Optional[List[Attachment]] = None
    author: Optional[User] = None
    body: Optional[StrictStr] = None
    created_at: Optional[datetime] = None
    draft: Optional[StrictBool] = None
    hide_archive_links: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["archive_download_count", "assets", "author", "body", "created_at", "draft", "hide_archive_links", "html_url", "id", "name", "prerelease", "published_at", "tag_name", "tarball_url", "target_commitish", "upload_url", "url", "zipball_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of archive_download_count
        if self.archive_download_count:
            _dict['archive_download_count'] = self.archive_download_count.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "archive_download_count": TagArchiveDownloadCount.from_dict(obj["archive_download_count"]) if obj.get("archive_download_count") is not None else None,
            ...
            "draft": obj.get("draft"),
            "hide_archive_links": obj.get("hide_archive_links"),
