...
class ContentsResponse(BaseModel):
    ...
    last_commit_when: Optional[datetime] = None
    ...
    __properties: ClassVar[List[str]] = ["_links", "content", "download_url", "encoding", "git_url", "html_url", "last_commit_sha", "last_commit_when", "name", "path", "sha", "size", "submodule_git_url", "target", "type", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "last_commit_when": obj.get("last_commit_when"),
            "name": obj.get("name"),
            "path": obj.get("path"),
            "sha": obj.get("sha"),
            "size": obj.get("size"),
