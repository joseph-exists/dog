...
class QuotaGroup(BaseModel):
    ...
    rules: Optional[List[QuotaRuleInfo]] = Field(default=None, description="Rules associated with the group")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "rules": [QuotaRuleInfo.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
