        ...
        if include_optional:
            return TimelineComment(
                assignee = openapi_client.models.user.User(
                    ...
                    visibility = '', 
                    website = '', ),
                assignee_team = openapi_client.models.team.Team(
                ...
                dependent_issue = openapi_client.models.issue.Issue(
                    assets = [
                ...
                new_ref = '',
                new_title = '',
                old_milestone = openapi_client.models.milestone.Milestone(
                    closed_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    closed_issues = 56, 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    description = '', 
                ...
                pull_request_url = '',
                ref_action = '',
                ref_comment = openapi_client.models.comment.Comment(
                    assets = [
                        openapi_client.models.attachment.Attachment(
                            browser_download_url = '', 
                            created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    user = openapi_client.models.user.User(
                        ...
                        website = '', ), ),
                ref_commit_sha = '',
                ref_issue = openapi_client.models.issue.Issue(
                    assets = [
                        openapi_client.models.attachment.Attachment(
                            browser_download_url = '', 
                            created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                ...
                resolve_doer = openapi_client.models.user.User(
                    active = True, 
                    avatar_url = '', 
                    created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    description = '', 
                    ...
                    website = '', ),
                review_id = 56,
                tracked_time = openapi_client.models.tracked_time.TrackedTime(
                    created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    id = 56, 
