...
[**activitypub_person_activity**](ActivitypubApi.md#activitypub_person_activity) | **GET** /activitypub/user-id/{user-id}/activities/{activity-id}/activity | Get a specific activity of the user
[**activitypub_person_activity_note**](ActivitypubApi.md#activitypub_person_activity_note) | **GET** /activitypub/user-id/{user-id}/activities/{activity-id} | Get a specific activity object of the user
[**activitypub_person_feed**](ActivitypubApi.md#activitypub_person_feed) | **GET** /activitypub/user-id/{user-id}/outbox | List the user&#39;s recorded activity
...
> ActivityPub activitypub_person_activity(user_id, activity_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ActivitypubApi(api_client)
    user_id = 56 # int | user ID of the user
    activity_id = 56 # int | activity ID of the sought activity

    try:
        # Get a specific activity of the user
        api_response = api_instance.activitypub_person_activity(user_id, activity_id)
        print("The response of ActivitypubApi->activitypub_person_activity:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActivitypubApi->activitypub_person_activity: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **user_id** | **int**| user ID of the user | 
 **activity_id** | **int**| activity ID of the sought activity | 
...
> ActivityPub activitypub_person_activity_note(user_id, activity_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a specific activity object of the user
        api_response = api_instance.activitypub_person_activity_note(user_id, activity_id)
        print("The response of ActivitypubApi->activitypub_person_activity_note:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActivitypubApi->activitypub_person_activity_note: %s\n" % e)
```
...
> List[APPersonFollowItem] activitypub_person_feed(user_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List the user's recorded activity
        api_response = api_instance.activitypub_person_feed(user_id)
        print("The response of ActivitypubApi->activitypub_person_feed:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ActivitypubApi->activitypub_person_feed: %s\n" % e)
```
...
[**List[APPersonFollowItem]**](APPersonFollowItem.md)
