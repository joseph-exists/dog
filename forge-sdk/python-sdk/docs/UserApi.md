...
[**user_create_token**](UserApi.md#user_create_token) | **POST** /users/{username}/tokens | Generate an access token for the current user
...
[**user_delete_access_token**](UserApi.md#user_delete_access_token) | **DELETE** /users/{username}/tokens/{token} | Delete an access token from current user&#39;s account
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UserApi(api_client)
    body = openapi_client.UserSettingsOptions() # UserSettingsOptions |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UserApi(api_client)
    body = openapi_client.CreateEmailOption() # CreateEmailOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Check if the authenticated user is over quota for a given subject
        api_response = api_instance.user_check_quota(subject)
        print("The response of UserApi->user_check_quota:\n")
        pprint(api_response)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UserApi(api_client)
    body = openapi_client.CreateOAuth2ApplicationOptions() # CreateOAuth2ApplicationOptions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.CreateAccessTokenOption() # CreateAccessTokenOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    page = 56 # int | page number of results to return (1-based) (optional)
    limit = 56 # int | page size of results (optional)
    order_by = 'order_by_example' # str | order the repositories (optional)
 ...
 **page** | **int**| page number of results to return (1-based) | [optional] 
 **limit** | **int**| page size of results | [optional] 
 **order_by** | **str**| order the repositories | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UserApi(api_client)
    form = openapi_client.CreateGPGKeyOption() # CreateGPGKeyOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UserApi(api_client)
    body = openapi_client.DeleteEmailOption() # DeleteEmailOption |  (optional)
...
> RegistrationToken user_get_runner_registration_token()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an user's actions runner registration token
        api_response = api_instance.user_get_runner_registration_token()
        print("The response of UserApi->user_get_runner_registration_token:\n")
        pprint(api_response)
    except Exception as e:
...
# **user_search**
> UserSearchResults user_search(q=q, uid=uid, sort=sort, page=page, limit=limit)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Search for users
        api_response = api_instance.user_search(q=q, uid=uid, sort=sort, page=page, limit=limit)
...
> List[ActionRunJob] user_search_run_jobs(labels=labels)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Search for user's action jobs according filter conditions
        api_response = api_instance.user_search_run_jobs(labels=labels)
        print("The response of UserApi->user_search_run_jobs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UserApi->user_search_run_jobs: %s\n" % e)
```
...
# **user_verify_gpg_key**
> GPGKey user_verify_gpg_key(body=body)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.UserApi(api_client)
    body = openapi_client.VerifyGPGKeyOption() # VerifyGPGKeyOption |  (optional)

    try:
        # Verify a GPG key
        api_response = api_instance.user_verify_gpg_key(body=body)
