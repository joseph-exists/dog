...
[**issue_remove_label**](IssueApi.md#issue_remove_label) | **DELETE** /repos/{owner}/{repo}/issues/{index}/labels/{identifier} | Remove a label from an issue
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.IssueLabelsOption() # IssueLabelsOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the issue
    body = openapi_client.AddTimeOption() # AddTimeOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the issue
    body = openapi_client.DeleteLabelsOption() # DeleteLabelsOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the issue
    body = openapi_client.CreateIssueCommentOption() # CreateIssueCommentOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreateIssueOption() # CreateIssueOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the issue
    body = openapi_client.IssueMeta() # IssueMeta |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreateMilestoneOption() # CreateMilestoneOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    content = openapi_client.EditReactionOption() # EditReactionOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    id = 56 # int | the milestone to delete, identified by ID and if not available by name
 ...
 **owner** | **str**| owner of the repo | 
 **repo** | **str**| name of the repo | 
 **id** | **int**| the milestone to delete, identified by ID and if not available by name | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    id = 56 # int | id of the comment to edit
    body = openapi_client.EditIssueCommentOption() # EditIssueCommentOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.EditIssueOption() # EditIssueOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.EditDeadlineOption() # EditDeadlineOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    id = 56 # int | the milestone to edit, identified by ID and if not available by name
    body = openapi_client.EditMilestoneOption() # EditMilestoneOption |  (optional)
 ...
 **owner** | **str**| owner of the repo | 
 **repo** | **str**| name of the repo | 
 **id** | **int**| the milestone to edit, identified by ID and if not available by name | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    id = 56 # int | the milestone to get, identified by ID and if not available by name
 ...
 **owner** | **str**| owner of the repo | 
 **repo** | **str**| name of the repo | 
 **id** | **int**| the milestone to get, identified by ID and if not available by name | 
...
# **issue_list_issues**
> List[Issue] issue_list_issues(owner, repo, state=state, labels=labels, q=q, type=type, milestones=milestones, since=since, before=before, created_by=created_by, assigned_by=assigned_by, mentioned_by=mentioned_by, page=page, limit=limit, sort=sort)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    page = 56 # int | page number of results to return (1-based) (optional)
    limit = 56 # int | page size of results (optional)
    sort = latest # str | Type of sort (optional) (default to latest)

    try:
        # List a repository's issues
        api_response = api_instance.issue_list_issues(owner, repo, state=state, labels=labels, q=q, type=type, milestones=milestones, since=since, before=before, created_by=created_by, assigned_by=assigned_by, mentioned_by=mentioned_by, page=page, limit=limit, sort=sort)
 ...
 **page** | **int**| page number of results to return (1-based) | [optional] 
 **limit** | **int**| page size of results | [optional] 
 **sort** | **str**| Type of sort | [optional] [default to latest]
...
# **issue_list_labels**
> List[Label] issue_list_labels(owner, repo, sort=sort, page=page, limit=limit)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all of a repository's labels
        api_response = api_instance.issue_list_labels(owner, repo, sort=sort, page=page, limit=limit)
...
# **issue_remove_label**
> issue_remove_label(owner, repo, index, identifier, body=body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the issue
    identifier = 'identifier_example' # str | name or id of the label to remove
    body = openapi_client.DeleteLabelsOption() # DeleteLabelsOption |  (optional)

    try:
        # Remove a label from an issue
        api_instance.issue_remove_label(owner, repo, index, identifier, body=body)
    except Exception as e:
 ...
 **repo** | **str**| name of the repo | 
 **index** | **int**| index of the issue | 
 **identifier** | **str**| name or id of the label to remove | 
 **body** | [**DeleteLabelsOption**](DeleteLabelsOption.md)|  | [optional] 
