...
[**get_node_info**](MiscellaneousApi.md#get_node_info) | **GET** /nodeinfo | Returns the nodeinfo of the Forgejo application
[**get_signing_key**](MiscellaneousApi.md#get_signing_key) | **GET** /signing-key.gpg | Get default signing-key.gpg
[**get_ssh_signing_key**](MiscellaneousApi.md#get_ssh_signing_key) | **GET** /signing-key.ssh | Get default signing-key.ssh
[**get_version**](MiscellaneousApi.md#get_version) | **GET** /version | Returns the version of the running application
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get default signing-key.ssh
        api_response = api_instance.get_ssh_signing_key()
        print("The response of MiscellaneousApi->get_ssh_signing_key:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MiscellaneousApi->get_ssh_signing_key: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.MiscellaneousApi(api_client)
    body = openapi_client.MarkdownOption() # MarkdownOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.MiscellaneousApi(api_client)
    body = openapi_client.MarkupOption() # MarkupOption |  (optional)
