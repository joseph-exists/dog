...
[**get_blobs**](RepositoryApi.md#get_blobs) | **GET** /repos/{owner}/{repo}/git/blobs | Gets multiplbe blobs of a repository.
...
# **action_run**
> ActionRun action_run(owner, repo, run_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    run_id = 56 # int | id of the action run

    try:
        # Get an action run
        api_response = api_instance.action_run(owner, repo, run_id)
        print("The response of RepositoryApi->action_run:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RepositoryApi->action_run: %s\n" % e)
```
 ...
 **run_id** | **int**| id of the action run | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.CreateForkOption() # CreateForkOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a repo-level variable
        api_instance.delete_repo_variable(owner, repo, variablename)
    except Exception as e:
...
# **dispatch_workflow**
> DispatchWorkflowRun dispatch_workflow(owner, repo, workflowfilename, body=body)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    workflowfilename = 'workflowfilename_example' # str | name of the workflow
    body = openapi_client.DispatchWorkflowOption() # DispatchWorkflowOption |  (optional)

    try:
        # Dispatches a workflow
        api_response = api_instance.dispatch_workflow(owner, repo, workflowfilename, body=body)
        print("The response of RepositoryApi->dispatch_workflow:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **owner** | **str**| owner of the repo | 
 **repo** | **str**| name of the repo | 
 **workflowfilename** | **str**| name of the workflow | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.GenerateRepoOption() # GenerateRepoOption |  (optional)
...
# **get_blob**
> GitBlob get_blob(owner, repo, sha)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    sha = 'sha_example' # str | sha of the blob to retrieve
 ...
 **owner** | **str**| owner of the repo | 
 **repo** | **str**| name of the repo | 
 **sha** | **str**| sha of the blob to retrieve | 
...
# **get_blobs**
> List[GitBlob] get_blobs(owner, repo, shas)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    shas = 'shas_example' # str | a comma separated list of blob-sha (mind the overall URL-length limit of ~2,083 chars)

    try:
        # Gets multiplbe blobs of a repository.
        api_response = api_instance.get_blobs(owner, repo, shas)
        print("The response of RepositoryApi->get_blobs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RepositoryApi->get_blobs: %s\n" % e)
```
 ...
 **owner** | **str**| owner of the repo | 
 **repo** | **str**| name of the repo | 
 **shas** | **str**| a comma separated list of blob-sha (mind the overall URL-length limit of ~2,083 chars) | 
...
# **list_action_runs**
> ListActionRunResponse list_action_runs(owner, repo, page=page, limit=limit, event=event, status=status, run_number=run_number, head_sha=head_sha)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    event = ['event_example'] # List[str] | Returns workflow run triggered by the specified events. For example, `push`, `pull_request` or `workflow_dispatch`. (optional)
    status = ['status_example'] # List[str] | Returns workflow runs with the check run status or conclusion that is specified. For example, a conclusion can be success or a status can be in_progress. Only Forgejo Actions can set a status of waiting, pending, or requested.  (optional)
    run_number = 56 # int | Returns the workflow run associated with the run number.  (optional)
    head_sha = 'head_sha_example' # str | Only returns workflow runs that are associated with the specified head_sha. (optional)

    try:
        # List a repository's action runs
        api_response = api_instance.list_action_runs(owner, repo, page=page, limit=limit, event=event, status=status, run_number=run_number, head_sha=head_sha)
        print("The response of RepositoryApi->list_action_runs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RepositoryApi->list_action_runs: %s\n" % e)
```
 ...
 **event** | [**List[str]**](str.md)| Returns workflow run triggered by the specified events. For example, &#x60;push&#x60;, &#x60;pull_request&#x60; or &#x60;workflow_dispatch&#x60;. | [optional] 
 **status** | [**List[str]**](str.md)| Returns workflow runs with the check run status or conclusion that is specified. For example, a conclusion can be success or a status can be in_progress. Only Forgejo Actions can set a status of waiting, pending, or requested.  | [optional] 
 **run_number** | **int**| Returns the workflow run associated with the run number.  | [optional] 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.AddCollaboratorOption() # AddCollaboratorOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreatePushMirrorOption() # CreatePushMirrorOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.UpdateFileOptions() # UpdateFileOptions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.ChangeFilesOptions() # ChangeFilesOptions | 
...
# **repo_convert**
> Repository repo_convert(owner, repo)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.RepositoryApi(api_client)
    owner = 'owner_example' # str | owner of the repo to convert
    repo = 'repo_example' # str | name of the repo to convert

    try:
        # Convert a mirror repo to a normal repo.
        api_response = api_instance.repo_convert(owner, repo)
        print("The response of RepositoryApi->repo_convert:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RepositoryApi->repo_convert: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **owner** | **str**| owner of the repo to convert | 
 **repo** | **str**| name of the repo to convert | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreateBranchRepoOption() # CreateBranchRepoOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreateBranchProtectionOption() # CreateBranchProtectionOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.CreateFileOptions() # CreateFileOptions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreateHookOption() # CreateHookOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreateKeyOption() # CreateKeyOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreatePullRequestOption() # CreatePullRequestOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.CreatePullReviewOptions() # CreatePullReviewOptions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.CreatePullReviewComment() # CreatePullReviewComment | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the pull request
    body = openapi_client.PullReviewRequestOptions() # PullReviewRequestOptions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreateReleaseOption() # CreateReleaseOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    sha = 'sha_example' # str | sha of the commit
    body = openapi_client.CreateStatusOption() # CreateStatusOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreateTagOption() # CreateTagOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreateTagProtectionOption() # CreateTagProtectionOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.CreateWikiPageOptions() # CreateWikiPageOptions |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.DeleteFileOptions() # DeleteFileOptions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    index = 56 # int | index of the pull request
    id = 56 # int | id of the review
    body = openapi_client.DismissPullReviewOptions() # DismissPullReviewOptions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.EditRepoOption() # EditRepoOption | Properties of a repo that you can edit (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    name = 'name_example' # str | name of protected branch
    body = openapi_client.EditBranchProtectionOption() # EditBranchProtectionOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    id = 'id_example' # str | id of the hook to get
    body = openapi_client.EditGitHookOption() # EditGitHookOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.EditPullRequestOption() # EditPullRequestOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.EditReleaseOption() # EditReleaseOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.EditAttachmentOptions() # EditAttachmentOptions |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    id = 56 # int | id of protected tag
    body = openapi_client.EditTagProtectionOption() # EditTagProtectionOption |  (optional)
...
> Dict[str, str] repo_get_editor_config(owner, repo, filepath, ref=ref)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get the EditorConfig definitions of a file in a repository
        api_response = api_instance.repo_get_editor_config(owner, repo, filepath, ref=ref)
        print("The response of RepositoryApi->repo_get_editor_config:\n")
        pprint(api_response)
    except Exception as e:
...
> RegistrationToken repo_get_runner_registration_token(owner, repo)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a repository's actions runner registration token
        api_response = api_instance.repo_get_runner_registration_token(owner, repo)
        print("The response of RepositoryApi->repo_get_runner_registration_token:\n")
        pprint(api_response)
    except Exception as e:
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the pull request to merge
    body = openapi_client.MergePullRequestOption() # MergePullRequestOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.RepositoryApi(api_client)
    body = openapi_client.MigrateRepoOptions() # MigrateRepoOptions |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.ReplaceFlagsOption() # ReplaceFlagsOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    is_private = True # bool | show only public, private or all repositories (defaults to all) (optional)
 ...
 **is_private** | **bool**| show only public, private or all repositories (defaults to all) | [optional] 
...
> List[ActionRunJob] repo_search_run_jobs(owner, repo, labels=labels)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Search for repository's action jobs according filter conditions
        api_response = api_instance.repo_search_run_jobs(owner, repo, labels=labels)
        print("The response of RepositoryApi->repo_search_run_jobs:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RepositoryApi->repo_search_run_jobs: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    sha = 'sha_example' # str | a git ref or commit sha
    body = openapi_client.NoteOptions() # NoteOptions |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    index = 56 # int | index of the pull request
    id = 56 # int | id of the review
    body = openapi_client.SubmitPullReviewOptions() # SubmitPullReviewOptions | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    branch = 'branch_example' # str | The branch

    try:
        # Syncs a fork branch with the base branch
        api_instance.repo_sync_fork_branch(owner, repo, branch)
    except Exception as e:
        print("Exception when calling RepositoryApi->repo_sync_fork_branch: %s\n" % e)
```
...
> SyncForkInfo repo_sync_fork_branch_info(owner, repo, branch)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets information about syncing a fork branch with the base branch
        api_response = api_instance.repo_sync_fork_branch_info(owner, repo, branch)
        print("The response of RepositoryApi->repo_sync_fork_branch_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RepositoryApi->repo_sync_fork_branch_info: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Syncs the default branch of a fork with the base branch
        api_instance.repo_sync_fork_default(owner, repo)
    except Exception as e:
        print("Exception when calling RepositoryApi->repo_sync_fork_default: %s\n" % e)
```
...
> SyncForkInfo repo_sync_fork_default_info(owner, repo)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets information about syncing the fork default branch with the base branch
        api_response = api_instance.repo_sync_fork_default_info(owner, repo)
        print("The response of RepositoryApi->repo_sync_fork_default_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RepositoryApi->repo_sync_fork_default_info: %s\n" % e)
```
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo to transfer
    repo = 'repo_example' # str | name of the repo to transfer
    body = openapi_client.TransferRepoOption() # TransferRepoOption | Transfer Options
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.UpdateRepoAvatarOption() # UpdateRepoAvatarOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    body = openapi_client.UpdateBranchRepoOption() # UpdateBranchRepoOption |  (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = openapi_client.RepoTopicOptions() # RepoTopicOptions |  (optional)
...
# **topic_search**
> TopicSearchResults topic_search(q, page=page, limit=limit)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.RepositoryApi(api_client)
    q = 'q_example' # str | keyword to search for
    page = 56 # int | page number of results to return (1-based) (optional)
    limit = 56 # int | page size of results (optional)
