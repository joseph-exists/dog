...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.NotificationApi(api_client)
    id = 56 # int | id of notification thread
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **id** | **int**| id of notification thread | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    all = True # bool | If true, mark all notifications on this repo. Default value is false (optional)
 ...
 **all** | **bool**| If true, mark all notifications on this repo. Default value is false | [optional] 
