...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.ActivitypubApi(api_client)
...
*ActivitypubApi* | [**activitypub_person_activity**](docs/ActivitypubApi.md#activitypub_person_activity) | **GET** /activitypub/user-id/{user-id}/activities/{activity-id}/activity | Get a specific activity of the user
*ActivitypubApi* | [**activitypub_person_activity_note**](docs/ActivitypubApi.md#activitypub_person_activity_note) | **GET** /activitypub/user-id/{user-id}/activities/{activity-id} | Get a specific activity object of the user
*ActivitypubApi* | [**activitypub_person_feed**](docs/ActivitypubApi.md#activitypub_person_feed) | **GET** /activitypub/user-id/{user-id}/outbox | List the user&#39;s recorded activity
...
*AdminApi* | [**admin_create_public_key**](docs/AdminApi.md#admin_create_public_key) | **POST** /admin/users/{username}/keys | Add an SSH public key to user&#39;s account
...
*AdminApi* | [**admin_create_user**](docs/AdminApi.md#admin_create_user) | **POST** /admin/users | Create a user account
...
*AdminApi* | [**admin_delete_user**](docs/AdminApi.md#admin_delete_user) | **DELETE** /admin/users/{username} | Delete user account
*AdminApi* | [**admin_delete_user_public_key**](docs/AdminApi.md#admin_delete_user_public_key) | **DELETE** /admin/users/{username}/keys/{id} | Remove a public key from user&#39;s account
...
*AdminApi* | [**admin_get_all_emails**](docs/AdminApi.md#admin_get_all_emails) | **GET** /admin/emails | List all users&#39; email addresses
...
*AdminApi* | [**admin_list_hooks**](docs/AdminApi.md#admin_list_hooks) | **GET** /admin/hooks | List global (system) webhooks
...
*AdminApi* | [**admin_search_emails**](docs/AdminApi.md#admin_search_emails) | **GET** /admin/emails/search | Search users&#39; email addresses
*AdminApi* | [**admin_search_run_jobs**](docs/AdminApi.md#admin_search_run_jobs) | **GET** /admin/runners/jobs | Search action jobs according filter conditions
...
*IssueApi* | [**issue_remove_label**](docs/IssueApi.md#issue_remove_label) | **DELETE** /repos/{owner}/{repo}/issues/{index}/labels/{identifier} | Remove a label from an issue
...
*MiscellaneousApi* | [**get_node_info**](docs/MiscellaneousApi.md#get_node_info) | **GET** /nodeinfo | Returns the nodeinfo of the Forgejo application
...
*MiscellaneousApi* | [**get_ssh_signing_key**](docs/MiscellaneousApi.md#get_ssh_signing_key) | **GET** /signing-key.ssh | Get default signing-key.ssh
*MiscellaneousApi* | [**get_version**](docs/MiscellaneousApi.md#get_version) | **GET** /version | Returns the version of the running application
...
*OrganizationApi* | [**create_org_variable**](docs/OrganizationApi.md#create_org_variable) | **POST** /orgs/{org}/actions/variables/{variablename} | Create a new variable in organization
...
*OrganizationApi* | [**delete_org_variable**](docs/OrganizationApi.md#delete_org_variable) | **DELETE** /orgs/{org}/actions/variables/{variablename} | Delete organization&#39;s variable by name
*OrganizationApi* | [**get_org_variable**](docs/OrganizationApi.md#get_org_variable) | **GET** /orgs/{org}/actions/variables/{variablename} | Get organization&#39;s variable by name
*OrganizationApi* | [**get_org_variables_list**](docs/OrganizationApi.md#get_org_variables_list) | **GET** /orgs/{org}/actions/variables | List variables of an organization
...
*OrganizationApi* | [**org_delete_avatar**](docs/OrganizationApi.md#org_delete_avatar) | **DELETE** /orgs/{org}/avatar | Delete an organization&#39;s avatar. It will be replaced by a default one
...
*OrganizationApi* | [**org_get_all**](docs/OrganizationApi.md#org_get_all) | **GET** /orgs | List all organizations
...
*OrganizationApi* | [**org_list_actions_secrets**](docs/OrganizationApi.md#org_list_actions_secrets) | **GET** /orgs/{org}/actions/secrets | List actions secrets of an organization
...
*OrganizationApi* | [**org_search_run_jobs**](docs/OrganizationApi.md#org_search_run_jobs) | **GET** /orgs/{org}/actions/runners/jobs | Search for organization&#39;s action jobs according filter conditions
...
*OrganizationApi* | [**org_update_avatar**](docs/OrganizationApi.md#org_update_avatar) | **POST** /orgs/{org}/avatar | Update an organization&#39;s avatar
...
*OrganizationApi* | [**update_org_variable**](docs/OrganizationApi.md#update_org_variable) | **PUT** /orgs/{org}/actions/variables/{variablename} | Update variable in organization
...
*RepositoryApi* | [**action_run**](docs/RepositoryApi.md#action_run) | **GET** /repos/{owner}/{repo}/actions/runs/{run_id} | Get an action run
...
*RepositoryApi* | [**dispatch_workflow**](docs/RepositoryApi.md#dispatch_workflow) | **POST** /repos/{owner}/{repo}/actions/workflows/{workflowfilename}/dispatches | Dispatches a workflow
...
*RepositoryApi* | [**get_blobs**](docs/RepositoryApi.md#get_blobs) | **GET** /repos/{owner}/{repo}/git/blobs | Gets multiplbe blobs of a repository.
...
*RepositoryApi* | [**list_action_runs**](docs/RepositoryApi.md#list_action_runs) | **GET** /repos/{owner}/{repo}/actions/runs | List a repository&#39;s action runs
...
*RepositoryApi* | [**repo_add_push_mirror**](docs/RepositoryApi.md#repo_add_push_mirror) | **POST** /repos/{owner}/{repo}/push_mirrors | Set up a new push mirror in a repository
...
*RepositoryApi* | [**repo_convert**](docs/RepositoryApi.md#repo_convert) | **POST** /repos/{owner}/{repo}/convert | Convert a mirror repo to a normal repo.
...
*RepositoryApi* | [**repo_delete_avatar**](docs/RepositoryApi.md#repo_delete_avatar) | **DELETE** /repos/{owner}/{repo}/avatar | Delete a repository&#39;s avatar
...
*RepositoryApi* | [**repo_delete_push_mirror**](docs/RepositoryApi.md#repo_delete_push_mirror) | **DELETE** /repos/{owner}/{repo}/push_mirrors/{name} | Remove a push mirror from a repository by remoteName
...
*RepositoryApi* | [**repo_list_pull_requests**](docs/RepositoryApi.md#repo_list_pull_requests) | **GET** /repos/{owner}/{repo}/pulls | List a repo&#39;s pull requests. If a pull request is selected but fails to be retrieved for any reason, it will be a null value in the list of results.
...
*RepositoryApi* | [**repo_search_run_jobs**](docs/RepositoryApi.md#repo_search_run_jobs) | **GET** /repos/{owner}/{repo}/actions/runners/jobs | Search for repository&#39;s action jobs according filter conditions
...
*RepositoryApi* | [**repo_sync_fork_branch**](docs/RepositoryApi.md#repo_sync_fork_branch) | **POST** /repos/{owner}/{repo}/sync_fork/{branch} | Syncs a fork branch with the base branch
*RepositoryApi* | [**repo_sync_fork_branch_info**](docs/RepositoryApi.md#repo_sync_fork_branch_info) | **GET** /repos/{owner}/{repo}/sync_fork/{branch} | Gets information about syncing a fork branch with the base branch
*RepositoryApi* | [**repo_sync_fork_default**](docs/RepositoryApi.md#repo_sync_fork_default) | **POST** /repos/{owner}/{repo}/sync_fork | Syncs the default branch of a fork with the base branch
*RepositoryApi* | [**repo_sync_fork_default_info**](docs/RepositoryApi.md#repo_sync_fork_default_info) | **GET** /repos/{owner}/{repo}/sync_fork | Gets information about syncing the fork default branch with the base branch
...
*RepositoryApi* | [**repo_update_avatar**](docs/RepositoryApi.md#repo_update_avatar) | **POST** /repos/{owner}/{repo}/avatar | Update a repository&#39;s avatar
...
*RepositoryApi* | [**topic_search**](docs/RepositoryApi.md#topic_search) | **GET** /topics/search | Search for topics by keyword
...
*UserApi* | [**get_user_settings**](docs/UserApi.md#get_user_settings) | **GET** /user/settings | Get current user&#39;s account settings
...
*UserApi* | [**update_user_settings**](docs/UserApi.md#update_user_settings) | **PATCH** /user/settings | Update settings in current user&#39;s account
...
*UserApi* | [**user_add_email**](docs/UserApi.md#user_add_email) | **POST** /user/emails | Add an email addresses to the current user&#39;s account
...
*UserApi* | [**user_create_token**](docs/UserApi.md#user_create_token) | **POST** /users/{username}/tokens | Generate an access token for the current user
...
*UserApi* | [**user_current_delete_gpg_key**](docs/UserApi.md#user_current_delete_gpg_key) | **DELETE** /user/gpg_keys/{id} | Remove a GPG public key from current user&#39;s account
...
*UserApi* | [**user_current_post_gpg_key**](docs/UserApi.md#user_current_post_gpg_key) | **POST** /user/gpg_keys | Add a GPG public key to current user&#39;s account
...
*UserApi* | [**user_delete_access_token**](docs/UserApi.md#user_delete_access_token) | **DELETE** /users/{username}/tokens/{token} | Delete an access token from current user&#39;s account
*UserApi* | [**user_delete_avatar**](docs/UserApi.md#user_delete_avatar) | **DELETE** /user/avatar | Delete avatar of the current user. It will be replaced by a default one
*UserApi* | [**user_delete_email**](docs/UserApi.md#user_delete_email) | **DELETE** /user/emails | Delete email addresses from the current user&#39;s account
...
*UserApi* | [**user_list_emails**](docs/UserApi.md#user_list_emails) | **GET** /user/emails | List all email addresses of the current user
...
*UserApi* | [**user_search_run_jobs**](docs/UserApi.md#user_search_run_jobs) | **GET** /user/actions/runners/jobs | Search for user&#39;s action jobs according filter conditions
*UserApi* | [**user_unblock_user**](docs/UserApi.md#user_unblock_user) | **PUT** /user/unblock/{username} | Unblocks a user from the doer
*UserApi* | [**user_update_avatar**](docs/UserApi.md#user_update_avatar) | **POST** /user/avatar | Update avatar of the current user
...
## Documentation For Models
 ...
 - [APIInternalServerError](docs/APIInternalServerError.md)
 ...
 - [APPersonFollowItem](docs/APPersonFollowItem.md)
 - [AccessToken](docs/AccessToken.md)
 - [ActionRun](docs/ActionRun.md)
 - [ActionRunJob](docs/ActionRunJob.md)
 ...
 - [DispatchWorkflowRun](docs/DispatchWorkflowRun.md)
 ...
 - [ListActionRunResponse](docs/ListActionRunResponse.md)
 ...
 - [UserSearchResults](docs/UserSearchResults.md)
 - [UserSettings](docs/UserSettings.md)
 - [UserSettingsOptions](docs/UserSettingsOptions.md)
 - [VerifyGPGKeyOption](docs/VerifyGPGKeyOption.md)
