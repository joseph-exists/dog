...
COMPLETE:  integrated into main models.py
...
- COMPLETE: integrated with crud.py, for-review-crud.py has been deleted.



## Participant API routes

Add the participant-management routes needed to satisfy Phase 1 “rooms + participants + events + projections” behavior, and ensure each route’s contract is enforced by role/membership checks and by emitting the correct events.[^1][^2]
