"""
extracting this from model_manager.py
where it's pulled in with 'from .known_models import KnownModelName'
from when model_manager existed as pydantic_ai/models/__init__.py
