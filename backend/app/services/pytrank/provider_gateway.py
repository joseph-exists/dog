...
### first commit: direct copy from pydantic_ai/providers/gateway.py
...
def gateway_provider(
    upstream_provider: Literal[
        "openai", "openai-chat", "openai-responses", "chat", "responses"
    ],
    /,
    *,
    route: str | None = None,
    ...
    if upstream_provider in (
        ...
        return AnthropicProvider(
            anthropic_client=AsyncAnthropic(
                auth_token=api_key, base_url=base_url, http_client=http_client
            )
        )
