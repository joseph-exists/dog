...
from openapi_client import CreateWikiPageOptions, ApiException

# Forge client and SDK imports (paths set up by main.py)
from app.test_scripts.forge_admin.typer_forge.forge_client import get_repository_api
...
def edit(
    ...
    from app.lib.python_forge_sdk.openapi_client.models.create_wiki_page_options import (
