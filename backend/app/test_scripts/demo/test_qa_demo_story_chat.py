    ...
    composition = {
        ...
        "panels": [
            ...
            # -----------------------------------------------------------------
            {
                ...
                "viewport_mode": "panel",
                "options": {
                    # KEY FEATURE: Story events appear in chat
                    # This creates a narrative log and enables agent responses
...
**Expected:** This instruction block should remain visible and unchanged throughout all interactions.""",
                    "metadata": {
                        "variant": "card"
                    }
                }
        ...
        "metadata_json": {
            "description": "QA Story + Chat + Constant Content test",
            "auto_respond": True,
...
def get_demo_config_payload(slug: str, title: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "metadata_json": {
            ...
            "test_scenario": "story_chat_constant_content"
        }
    }
