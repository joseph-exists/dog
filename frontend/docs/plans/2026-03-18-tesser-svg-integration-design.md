...
**Date**: 2026-03-18
**Status**: Under Review: See Open Questions
...
Question 1:  Does this architecture align with our frontend composition and enable the suite of interdependent functionality and affordances which are our top-level concerns?

Question 2: Does this plan take into consideration the variability of tesser script affordances, including depth of parameterization?

Question 3: Does this plan enable later enabling through various other interfaces, including but not limited to Rooms, Demos, Projects?

Question 4: Does this plan create an extensible foundation for increasing the variance of scripts tesser has available?

Question 5:  Does this plan use existing SVG types, primitives and methods when appropriate?

Question 6: Does this plan use our existing UI primitives when appropriate?

Question 7: Does this plan enable sharing of work in flight as well as work completed?
