 ...
 * StoryPlayerPanel
 *
 * Solo/local story player for room panels. Fetches the room's attached story
 * and lets the player navigate through nodes and choices entirely client-side.
 * Emits story progress events to the room so agents can react to narrative context.
 */
...
export function StoryPlayerPanel({
  ...
  if (!storyId) {
    return (
      <PanelContainer title="Story Player">
        <PlaceholderContent
          icon={BookOpen}
          title="No Story Attached"
          description="This room doesn't have a story attached yet."
        />
      </PanelContainer>
    )
  }
  ...
  return (
    <PanelContainer title="Story Player" headerActions={headerActions}>
