...
SVG Library: Gallery View: need tagging controls on preview?
...
SVG dialogs:  Batch seed needs extended - still a long way from our plan in it's current form.  this feels hokey - it needs significant extensibility in order to be a real creative design interface.
