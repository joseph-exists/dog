 ...
 */
export type AffordanceReference = {
    name: string;
    description: string;
    category: string;
    required_dimensions?: Array<(string)>;
    optional_dimensions?: Array<(string)>;
};
...
export type AvailableResult = {
    affordances: Array<AffordanceReference>;
    by_category: {
        [key: string]: Array<AffordanceReference>;
    };
    unavailable?: Array<{
        [key: string]: unknown;
    }>;
...
export type CompositionContext = {
    ...
    chat_mode?: string;
    panels?: Array<PanelContext>;
    blocks?: Array<BlockContext>;
};
 ...
 */
export type Context_Input = {
    user: UserContext;
    demo_config?: (DemoConfigContext | null);
    composition?: (CompositionContext | null);
 ...
 */
export type ElaborateResult = {
    affordance: string;
    specified: {
        [key: string]: unknown;
    };
    remaining: Array<RemainingDimension>;
    can_proceed: boolean;
...
/**
 * Request for a payload example.
 */
export type PayloadExampleRequest = {
    affordance: string;
    parameters?: {
        [key: string]: unknown;
    };
...
/**
 * Response with example payload and annotations.
 */
export type PayloadExampleResponse = {
    affordance: string;
    api_endpoint: string;
    http_method: string;
    payload: {
...
export type PreviewResult = {
    ...
    resulting_state?: (Context_Output | null);
    newly_enabled?: Array<AffordanceReference>;
    newly_precluded?: Array<AffordanceReference>;
...
/**
 * Union of all query types - discriminated by operation field.
 */
export type QueryRequest = {
    operation: 'available' | 'preview' | 'elaborate' | 'explain' | 'pathTo';
...
export type operation = 'available' | 'preview' | 'elaborate' | 'explain' | 'pathTo';

/**
 * Quick query for available affordances.
 */
export type QuickAvailableRequest = {
    context?: QuickContextRequest;
};

/**
 * Simplified context for quick queries.
 *
 * Instead of building a full Context object, provide just the
 * pieces you have. The endpoint will construct the context.
 */
export type QuickContextRequest = {
    user_id?: string;
    is_superuser?: boolean;
    demo_config_id?: (string | null);
    demo_config_slug?: (string | null);
...
/**
 * Quick query for elaborating an intent.
 */
export type QuickElaborateRequest = {
    context?: QuickContextRequest;
    affordance: string;
    parameters?: {
        [key: string]: unknown;
...
/**
 * Quick query for previewing an action.
 */
export type QuickPreviewRequest = {
    context?: QuickContextRequest;
    affordance: string;
    parameters?: {
        [key: string]: unknown;
 ...
 */
export type RemainingDimension = {
    dimension: string;
    type: string;
    required: boolean;
...
export type AffordancesQueryAffordancesData = {
    requestBody: QueryRequest;
};

export type AffordancesQueryAffordancesResponse = ({
    [key: string]: unknown;
});

export type AffordancesQueryAvailableData = {
    requestBody: QuickAvailableRequest;
};

export type AffordancesQueryAvailableResponse = (AvailableResult);

export type AffordancesQueryPreviewData = {
    requestBody: QuickPreviewRequest;
};

export type AffordancesQueryPreviewResponse = (PreviewResult);

export type AffordancesQueryElaborateData = {
    requestBody: QuickElaborateRequest;
};

export type AffordancesQueryElaborateResponse = (ElaborateResult);

export type AffordancesGetRegistryResponse = ({
    [key: string]: unknown;
});

export type AffordancesListDimensionsResponse = ({
    [key: string]: Dimension;
});

export type AffordancesListAffordancesResponse = (Array<AffordanceReference>);

export type AffordancesGetAffordanceData = {
    affordanceName: string;
};

export type AffordancesGetAffordanceResponse = ({
    [key: string]: unknown;
});

export type AffordancesGetPatternData = {
    patternName: string;
};

export type AffordancesGetPatternResponse = ({
    [key: string]: unknown;
});

export type AffordancesGetPayloadExampleData = {
    requestBody: PayloadExampleRequest;
};

export type AffordancesGetPayloadExampleResponse = (PayloadExampleResponse);

export type AffordancesGetPanelSchemaData = {
    panelKind: string;
};

export type AffordancesGetPanelSchemaResponse = ({
    [key: string]: unknown;
});
