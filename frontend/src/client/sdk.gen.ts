...
export class AgentsService {
     ...
     * @returns AvailableAgentsPublic Successful Response
     * @throws ApiError
     */
    public static getAvailableAgents(): CancelablePromise<AgentsGetAvailableAgentsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
