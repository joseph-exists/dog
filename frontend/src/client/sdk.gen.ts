...
export class LlmCatalogService {
     ...
     * @throws ApiError
     */
    public static listModels(): CancelablePromise<LlmCatalogListModelsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
