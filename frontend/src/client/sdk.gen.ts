...
export class AgentsService {
     ...
     * @throws ApiError
     */
    public static runAgent(): CancelablePromise<AgentsRunAgentResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/agents/pydantic-agent'
        });
    }
}
