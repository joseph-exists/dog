...
export const ActionSchema = {
    ...
    required: ['affordance'],
    title: 'Action',
    description: 'A proposed invocation of an affordance.'
} as const;

export const AffordanceReferenceSchema = {
    properties: {
        name: {
            type: 'string',
            title: 'Name'
    ...
    title: 'AffordanceReference',
    description: 'Lightweight reference to an affordance.'
} as const;
...
export const AvailableResultSchema = {
    properties: {
        affordances: {
            items: {
                '$ref': '#/components/schemas/AffordanceReference'
            },
            type: 'array',
            title: 'Affordances'
        },
    ...
    type: 'object',
    required: ['affordances', 'by_category'],
    title: 'AvailableResult',
    description: 'Result of available query.'
} as const;
...
export const BlockContextSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
    ...
    required: ['id', 'type'],
    title: 'BlockContext',
    description: 'Block state within a composition.'
} as const;
...
export const CompositionContextSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
    ...
    type: 'object',
    required: ['id', 'demo_config_id'],
    title: 'CompositionContext',
    description: 'Composition state for affordance evaluation.'
} as const;

export const ConstraintViolationSchema = {
    properties: {
        constraint_id: {
            type: 'string',
            title: 'Constraint Id'
    ...
    type: 'object',
    required: ['constraint_id', 'dimension', 'predicate', 'message'],
    title: 'ConstraintViolation',
    description: 'Explains why a constraint was violated.'
} as const;
...
export const Context_InputSchema = {
    properties: {
        user: {
        ...
        demo_config: {
            anyOf: [
                {
                    '$ref': '#/components/schemas/DemoConfigContext'
                },
                {
                    type: 'null'
                }
        ...
        composition: {
            anyOf: [
                {
                    '$ref': '#/components/schemas/CompositionContext'
                },
                {
                    type: 'null'
                }
    ...
    required: ['user'],
    title: 'Context',
    description: 'Complete context for affordance evaluation.'
} as const;

export const Context_OutputSchema = {
    properties: {
        user: {
            '$ref': '#/components/schemas/UserContext'
        },
...
export const DemoConfigContextSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
    ...
    type: 'object',
    required: ['id', 'slug', 'scope', 'owner_id'],
    title: 'DemoConfigContext',
    description: 'Demo config state for affordance evaluation.'
} as const;
...
export const DimensionSchema = {
    ...
    required: ['type'],
    title: 'Dimension',
    description: 'A dimension is an axis along which affordances vary.'
} as const;
...
export const EffectSchema = {
    ...
    type: 'object',
    required: ['dimension', 'change', 'target'],
    title: 'Effect',
    description: 'Describes what changes when an affordance is invoked.'
} as const;

export const ElaborateResultSchema = {
    properties: {
        affordance: {
            type: 'string',
            title: 'Affordance'
        ...
        remaining: {
            items: {
                '$ref': '#/components/schemas/RemainingDimension'
            },
            type: 'array',
            title: 'Remaining'
        },
    ...
    type: 'object',
    required: ['affordance', 'specified', 'remaining', 'can_proceed'],
    title: 'ElaborateResult',
    description: 'Result of elaborate query.'
} as const;
...
export const PanelContextSchema = {
    properties: {
        id: {
            type: 'string',
            title: 'Id'
    ...
    required: ['id', 'kind'],
    title: 'PanelContext',
    description: 'Panel state within a composition.'
} as const;
...
export const PayloadExampleRequestSchema = {
    properties: {
        affordance: {
            type: 'string',
            title: 'Affordance'
    ...
    type: 'object',
    required: ['affordance'],
    title: 'PayloadExampleRequest',
    description: 'Request for a payload example.'
} as const;

export const PayloadExampleResponseSchema = {
    properties: {
        affordance: {
            type: 'string',
            title: 'Affordance'
    ...
    type: 'object',
    required: ['affordance', 'api_endpoint', 'http_method', 'payload', 'annotations'],
    title: 'PayloadExampleResponse',
    description: 'Response with example payload and annotations.'
} as const;
...
export const PreviewResultSchema = {
    properties: {
        ...
        resulting_state: {
            anyOf: [
                {
                    '$ref': '#/components/schemas/Context-Output'
                },
                {
                    type: 'null'
                }
    ...
    required: ['valid'],
    title: 'PreviewResult',
    description: 'Result of preview query.'
} as const;
...
export const QueryRequestSchema = {
    properties: {
        operation: {
            type: 'string',
            enum: ['available', 'preview', 'elaborate', 'explain', 'pathTo'],
            title: 'Operation'
        },
        context: {
            '$ref': '#/components/schemas/Context-Input'
        },
        action: {
            anyOf: [
                {
    ...
    title: 'QueryRequest',
    description: 'Union of all query types - discriminated by operation field.'
} as const;

export const QuickAvailableRequestSchema = {
    properties: {
        context: {
    ...
    type: 'object',
    title: 'QuickAvailableRequest',
    description: 'Quick query for available affordances.'
} as const;

export const QuickContextRequestSchema = {
    properties: {
        user_id: {
            type: 'string',
            title: 'User Id',
    ...
    description: `Simplified context for quick queries.

Instead of building a full Context object, provide just the
pieces you have. The endpoint will construct the context.`
} as const;

export const QuickElaborateRequestSchema = {
    properties: {
        context: {
            '$ref': '#/components/schemas/QuickContextRequest'
        },
    ...
    type: 'object',
    required: ['affordance'],
    title: 'QuickElaborateRequest',
    description: 'Quick query for elaborating an intent.'
} as const;

export const QuickPreviewRequestSchema = {
    properties: {
        context: {
            '$ref': '#/components/schemas/QuickContextRequest'
        },
    ...
    type: 'object',
    required: ['affordance'],
    title: 'QuickPreviewRequest',
    description: 'Quick query for previewing an action.'
} as const;

export const RemainingDimensionSchema = {
    properties: {
        dimension: {
            type: 'string',
            title: 'Dimension'
    ...
    type: 'object',
    required: ['dimension', 'type', 'required'],
    title: 'RemainingDimension',
    description: 'A dimension that still needs specification.'
} as const;
...
export const SessionContextSchema = {
    ...
    type: 'object',
    required: ['id', 'demo_config_id', 'user_id', 'room_id'],
    title: 'SessionContext',
    description: 'Session state for affordance evaluation.'
} as const;
